...
-- Then we can create indexes on the materialized view
create index idx_weekly_cohorts_first_week on weekly_cohorts_view(first_week);
create index idx_weekly_cohorts_active_week on weekly_cohorts_view(active_week);
create index idx_weekly_cohorts_session on weekly_cohorts_view(session_id); 