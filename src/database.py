...
def get_mau_data(session_id, start_date, end_date):
    ...
    if isinstance(conn, SupabaseConnection):
        ...
        result = conn.query(mau_query).execute({
...
def get_wau_data(session_id, start_date, end_date):
    ...
    if isinstance(conn, SupabaseConnection):
        ...
        result = conn.query(wau_query).execute({
            'start_date': start_date,
            'end_date': end_date
        })
...
def get_dau_data(session_id, start_date, end_date):
    ...
    if isinstance(conn, SupabaseConnection):
        ...
        result = conn.query(dau_query).execute({
            'start_date': start_date,
            'end_date': end_date
        })
...
def get_monthly_retention_rates(session_id, start_date, end_date):
    ...
    if isinstance(conn, SupabaseConnection):
        ...
        result = conn.query(retention_query).execute({
            'start_date': start_date,
            'end_date': end_date
        })
...
def get_monthly_quick_ratio(session_id, start_date, end_date):
    ...
    if isinstance(conn, SupabaseConnection):
        ...
        result = conn.query(quick_ratio_query).execute({
            'start_date': start_date,
            'end_date': end_date
        })
...
def get_mrr_data(session_id, start_date, end_date):
    ...
    if isinstance(conn, SupabaseConnection):
        ...
        result = conn.query(mrr_query).execute({
            'start_date': start_date,
            'end_date': end_date
        })
...
def get_wrr_data(session_id, start_date, end_date):
    ...
    if isinstance(conn, SupabaseConnection):
        ...
        result = conn.query(wrr_query).execute({
            'start_date': start_date,
            'end_date': end_date
        })
...
def get_drr_data(session_id, start_date, end_date):
    ...
    if isinstance(conn, SupabaseConnection):
        ...
        result = conn.query(drr_query).execute({
            'start_date': start_date,
            'end_date': end_date
        })
...
def get_monthly_cohorts(session_id, start_date, end_date):
    ...
    if isinstance(conn, SupabaseConnection):
        ...
        result = conn.query(cohorts_query).execute({
            'start_date': start_date,
            'end_date': end_date
        })
    ...
    if isinstance(conn, SupabaseConnection):
        try:
            ...
            conn.query(f"""
                ...
                SELECT * FROM json_populate_recordset(null::{table_name}, :values::json)
            """).execute({'values': json.dumps(values)})
