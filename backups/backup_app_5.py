...
def main():
    ...
    tab1, growth_tab, retention_tab, quick_ratio_tab, tab7 = st.tabs([
        "Data Upload", 
        "Growth",
    ...
    with growth_tab:
        ...
        with filter_col1:
            st.markdown("Select Period", help="Choose the time period for growth analysis")
            growth_frequency = st.selectbox(
                "",
                options=["Monthly", "Weekly", "Daily"],
                key="combined_growth_frequency",
