    ...
    with tab8:
        ...
        if st.session_state.data_generated:
            ...
            with col1:
                ...
                if cohort_frequency == "Monthly" and 'monthly_cohort_data' in st.session_state:
                    plot_cohorts(st.session_state.monthly_cohort_data)
                elif cohort_frequency == "Weekly" and 'weekly_cohort_data' in st.session_state:
                    plot_weekly_retention_cohorts(st.session_state.weekly_cohort_data)
                elif cohort_frequency == "Daily" and 'daily_cohort_data' in st.session_state:
